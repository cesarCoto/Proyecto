...
public class TerceraLeyActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(R.id.contenido_TL, new IncioTerceraLeyFragment()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        if (id == R.id.nav_home_TL) {
            transaction.replace(R.id.contenido_TL, new IncioTerceraLeyFragment()).commit();
        } else if (id == R.id.nav_ejemplos_TL) {
            transaction.replace(R.id.contenido_TL, new ExamplesTerceraLeyFragment()).commit();
        } else if (id == R.id.nav_feedback_TL) {
            ...
            intentMensaje.putExtra(Intent.EXTRA_SUBJECT,getString(R.string.tercera_ley_title));
